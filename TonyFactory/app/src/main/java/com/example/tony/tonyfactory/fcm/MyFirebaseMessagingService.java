...
import com.example.tony.tonyfactory.main.TestActivity;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            try {
                ...
                //start Activity Lucky Tag Activity
                ...
                if (!screenOn) {
                    ...
                    Intent alert = new Intent(this, TestActivity.class);
//                    alert.putExtra("item", item);
...
//            JSONObject msObj = json.getJSONObject("message");
